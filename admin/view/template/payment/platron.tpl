      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="platron_merchant" value="<?php echo $platron_merchant; ?>" />
          ...
          <tr>
            ...
            <td><input type="text" name="platron_security" value="<?php echo $platron_security; ?>" />
          ...
          <tr>
            ...
            <td><input type="text" name="platron_total" value="<?php echo $platron_total; ?>" /></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><select name="platron_geo_zone_id">
                <option value="0"><?php echo $text_all_zones; ?></option>
                <?php foreach ($geo_zones as $geo_zone) { ?>
                <?php if ($geo_zone['geo_zone_id'] == $platron_geo_zone_id) { ?>
